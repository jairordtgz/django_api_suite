...
SECRET_KEY = "django-insecure-8rixr7@#yk-tiwk=vfo1en_z_th26zlq8o63(wgzv6ir4u(*z$"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['jairodri.pythonanywhere.com']
...
firebase_admin.initialize_app(FIREBASE_CREDENTIALS_PATH, {
   'databaseURL': 'https://landing-4a872-default-rtdb.firebaseio.com'
})